(function() {
  ...
  BootLoader = (function() {
    ...
    BootLoader.prototype.reopenApplicationFromDisk = function() {
      ...
      if (id !== "") {
        ...
        return this.alert_about_different_mode(this.application_json, function() {
          ...
          if (_this.debug) {
            console.log("" + (JSON.stringify(_this.application_json)));
          }
    ...
    BootLoader.prototype.local_url_for_ip = function(ip) {
      return "http://" + ip + ":4567/appgyver/api/applications/1.json?client_version=" + window.AG_CLIENT_VERSION;
    };
        ...
        return this.send("wipeDevice", {
          callbacks: {
            success: function() {
              ...
              if (_this.debug) console.log("Connecting to: " + _this.json_url);
