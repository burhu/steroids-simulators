  ...
  window.Studio = (function() {
    ...
    Studio.prototype.load = function() {
      ...
      if (this.application_json.build_timestamp) {
        this.application_json.application_path = "applications/local/" + this.application_json.build_timestamp;
      } else {
        this.application_json.application_path = "applications/cloud/" + (Math.round(new Date().getTime() / 1000));
      }
    ...
    Studio.prototype.download_archive = function(archive) {
      ...
      my_uid = this.uid++;
      name = "" + this.application_json.application_path + "/__appgyver/archives/archive_" + my_uid;
    ...
    Studio.prototype.extract_archive = function(name) {
      ...
      return this.send("unzip", {
        parameters: {
          filenameWithPath: name,
          path: this.application_json.application_path
        },
        callbacks: {
          success: function() {
    ...
    Studio.prototype.handle_files = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(this.send("downloadFile", {
          parameters: {
            filenameWithPath: "" + this.application_json.application_path + "/" + file.path,
            url: file.url
          },
          callbacks: {
            success: function() {
    ...
    Studio.prototype.finish = function() {
      ...
      return this.send("startApplication", {
        parameters: {
          ...
          appearance: this.application_json.appearance,
